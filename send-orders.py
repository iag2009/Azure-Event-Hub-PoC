...
async def send_events():
    ...
    async with producer:
        ...
        orders = [
            {"OrderID": "O1", "Quantity": 10, "UnitPrice": 1.01, "DiscountCategory": "Tier 1"},
            {"OrderID": "O2", "Quantity": 15, "UnitPrice": 2.02, "DiscountCategory": "Tier 2"},
            {"OrderID": "O3", "Quantity": 20, "UnitPrice": 3.03, "DiscountCategory": "Tier 3"},
            {"OrderID": "O4", "Quantity": 25, "UnitPrice": 4.04, "DiscountCategory": "Tier 1"},
            {"OrderID": "O5", "Quantity": 30, "UnitPrice": 5.05, "DiscountCategory": "Tier 2"}
        ]
